...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i = 0; i < [buttonTitles count]; i++) {
        ...
        [closeButton setTitleColor:TEXT_COLOR_WHITE forState:UIControlStateHighlighted];
        [closeButton setTitleColor:TEXT_COLOR_WHITE forState:UIControlStateNormal];
        
        [closeButton.titleLabel setFont:FONT_18_BOLD];
        [closeButton setBackgroundColor:TEXT_COLOR_CYNA];
