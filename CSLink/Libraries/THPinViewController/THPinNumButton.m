...
- (instancetype)initWithNumber:(NSUInteger)number letters:(NSString *)letters
{
    ...
    if (self)
    {
        ...
        _numberLabel.font = (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) ? FONT_50_LIGHT : FONT_30_LIGHT;
        ...
        if (letters)
        {
            ...
            _lettersLabel.font = [UIFont systemFontOfSize:(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) ? 30.0f : 9.0f];
...
//                                                                                  views:@{ @"lettersLabel" : _lettersLabel }]];
         ...
         //   CGSize lettersSize = [_lettersLabel.text sizeWithAttributes:@{ NSFontAttributeName : _lettersLabel.font }];
            ...
            contentViewHeight +=  numberLabelYCorrection;
...
{
    self.layer.borderColor =[UIColor clearColor].CGColor;// [self.tintColor CGColor];
