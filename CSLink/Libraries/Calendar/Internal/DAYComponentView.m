...
- (void)setContainingEvent:(NSDictionary *)containingEvent {
    self->_containingEvent = containingEvent;
    
    if (containingEvent) {
        self.dotLayer.fillColor = [UIColor colorWithRed:0.93 green:0.93 blue:0.93 alpha:1].CGColor;
...
- (void)setSelected:(BOOL)selected {
    if (selected) {
		...
		self.dotLayer.fillColor = TEXT_COLOR_CYNA.CGColor;
    }
}
