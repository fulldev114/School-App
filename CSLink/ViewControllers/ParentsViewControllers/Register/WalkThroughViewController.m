...
- (void)viewDidLoad
{
    ...
    [self.navigationItem setTitleView:[BaseViewController setNavigationTitle:[GeneralUtil getLocalizedText:@"TITLE_REGISTER"]]];
...
- (void)keyboardDidShow: (NSNotification *) notif{
   ...
   // scrollViewSize = self.scrollview.contentSize;
    
   // CGSize content = CGSizeMake(300, scrollViewSize.height);
