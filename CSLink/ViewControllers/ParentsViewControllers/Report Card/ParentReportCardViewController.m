...
@interface ParentReportCardViewController ()<ParentNIDropDownDelegate>
{
...
@implementation ParentReportCardViewController
...
- (void)viewDidLoad {
    ...
    [BaseViewController setNavigationMenu:self title:[GeneralUtil getLocalizedText:@"TITLE_REPORT_CARD"] WithSel:@selector(menuClick)];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    if (section == 0) {
        ...
        if (dicMarkDetail && [dicMarkDetail count] > section - 1) {
...
//    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    ...
    static NSString *simpleTableIdentifier = @"ParentmarksTableViewCell";
    
    ParentmarksTableViewCell *cell = (ParentmarksTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell == nil) {
//        cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:simpleTableIdentifier];
        
        NSArray *nib=[[NSBundle mainBundle] loadNibNamed:@"ParentmarksTableViewCell" owner:self options:nil];
...
- (IBAction)btnInfoPress:(UIButton *)sender {
    ...
    NSIndexPath *indexPath = [tblSemesterList indexPathForCell:(ParentmarksTableViewCell *)sender.superview.superview.superview];
...
//                for (int i = 0; i < [dicMarkDetail count]; i++) {
//                    NSDictionary *d = [dicMarkDetail objectAtIndex:i];
//                    if ([[d valueForKey:@"semester_id"] isEqualToString:selcteSem]) {
//                        inx = i;
//                        [dicMarkDetail removeObject:d];
//                    }
//                }
                [tblSemesterList reloadData];
...
-(void)getSubjectAndMarks {
    ...
    if ([selectedYear isEqualToString:@""] || selectedYear == nil) {
        ...
        [userObj getSubjectAndMarks:[[GeneralUtil getUserPreference:key_selectedStudant]  valueForKey:@"school_class_id"] year:selectedYear semesterId:selectedSemId userId:[[GeneralUtil getUserPreference:key_selectedStudant]  valueForKey:@"user_id"]  :^(NSObject *resObj) {
