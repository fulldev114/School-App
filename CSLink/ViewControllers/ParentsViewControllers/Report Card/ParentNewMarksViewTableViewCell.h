...
@class ParentNewMarksViewTableViewCell;

@protocol ParentNewMarksViewTableViewCellDelegate
...
@interface ParentNewMarksViewTableViewCell : UITableViewCell
...
@property (nonatomic, assign) id <ParentNewMarksViewTableViewCellDelegate> delegate;
