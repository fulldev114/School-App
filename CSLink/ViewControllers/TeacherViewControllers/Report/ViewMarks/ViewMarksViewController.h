...
@interface ViewMarksViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,PEARSlideViewDelegate>
{
    ...
    __weak IBOutlet UIView *bottomFirstSem;
    __weak IBOutlet UIView *bottomSecSem;
