...
@interface TeacherCharacterReportViewController ()<TeacherNIDropDownDelegate>
{
...
@implementation TeacherCharacterReportViewController
...
-(void)getSemester {
  ...
  //  [userObj getStudantBehaviour:[dicStudantDetail valueForKey:@"class_id"] schoolId:[GeneralUtil getUserPreference:key_schoolId] userId:[dicStudantDetail valueForKey:@"user_id"] sDate:@"" eDate:@"" :^(NSObject *resObj)
    {
    ...
    if ([selectedYear isEqualToString:@""] || selectedYear == nil) {
        ...
        if (sender.selected) {
            ...
            if ([arrSelSemId containsObject:selcteSem]) {
                ...
                //                if ([arrCharacterDetail count] > inx) {
                //                    [arrCharacterDetail removeObjectAtIndex:inx];
                //                }
...
-(void)getSubjectAndMarks {
    ...
    if ([selectedYear isEqualToString:@""] || selectedYear == nil) {
        ...
        [userObj getCharecterAndGrade:[dicStudantDetail valueForKey:@"class_id"] year:selectedYear semesterId:selectedSemId userId:[dicStudantDetail valueForKey:@"user_id"] schoolId:[GeneralUtil getUserPreference:key_schoolId] : ^(NSObject *resObj) {
